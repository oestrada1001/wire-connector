...
Class WireConnectorMail{
    private $user = 'Jake Fishman';
    private $email = 'jfishman@insight-links.com';
    private $website = 'https://www.theimagingwire.com';
    private $website_name = 'The Imaging Wire';

    public function new_subscriber_template($subscriber,$special_link)
    {
        $template_body = "
...
<body class=\"clean-body\" style=\"margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #C0DDF1;\">
...
<table bgcolor=\"#C0DDF1\" cellpadding=\"0\" cellspacing=\"0\" class=\"nl-container\" role=\"presentation\" style=\"table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #C0DDF1; width: 100%;\" valign=\"top\" width=\"100%\">
<tbody>
<tr style=\"vertical-align: top;\" valign=\"top\">
<td style=\"word-break: break-word; vertical-align: top; border-collapse: collapse;\" valign=\"top\">
<!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td align=\"center\" style=\"background-color:#C0DDF1\"><![endif]-->
...
<p style=\"font-size: 14px; line-height: 33px; text-align: center; margin: 0;\"><span style=\"font-size: 28px;\"><strong><span style=\"line-height: 33px; font-size: 28px;\">Hello $subscriber,</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style=\"font-size: 14px; line-height: 21px; text-align: center; margin: 0;\">Thanks so much for subscribing to</p>
<p style=\"font-size: 14px; line-height: 21px; text-align: center; margin: 0;\">$this->website<span style=\"color: #a8bf6f; font-size: 14px; line-height: 21px;\"></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
